...
//３．データ登録SQL作成
$sql = "INSERT INTO gs_an_table(name,pname,naiyou,indate,kekka,img)VALUES(:name,:pname,:naiyou,sysdate(),:kekka,:img)";
$stmt = $pdo->prepare($sql);
$stmt->bindValue(':name', $name, PDO::PARAM_STR); //Integer（数値の場合 PDO::PARAM_INT)
$stmt->bindValue(':pname', $pname, PDO::PARAM_STR); //Integer（数値の場合 PDO::PARAM_INT)
$stmt->bindValue(':naiyou', $naiyou, PDO::PARAM_STR); //Integer（数値の場合 PDO::PARAM_INT)
$stmt->bindValue(':kekka', $kekka, PDO::PARAM_STR); //Integer（数値の場合 PDO::PARAM_INT)
